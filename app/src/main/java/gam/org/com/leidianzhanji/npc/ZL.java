    ...
    public void updata(NPCManager nm) {
        ...
        if (Game.level <= GameWin.MAX_LEVEL) {
            ...
            if (time >= bosst && isBoss == false) {
                switch (Game.level) {
                    case 1:
                        nm.create(101, 950, -130, 0, 201);
                        break;
                    case 2:
                        nm.create(102, 950, -130, 0, 202);
                        break;
                    case 3:
                        nm.create(103, 950, -130, 0, 204);
                        break;
                    case 4:
                        nm.create(104, 950, -130, 0, 206);
                        break;
                    case 5:
                        nm.create(105, 950, -130, 0, 205);
                        break;
                    case 6:
                        nm.create(106, 950, -130, 0, 203);
                        break;
                    case 7:
                        nm.create(107, 950, -130, 0, 207);
                        break;
                    case 8:
                        nm.create(108, 950, -130, 0, 208);
                        break;
                    case 9:
                        nm.create(109, 950, -130, 0, 210);
                        break;
                    case 10:
                        nm.create(110, 950, -130, 0, 212);
                        break;
                    case 11:
                        nm.create(111, 950, -130, 0, 211);
                        break;
                    case 12:
                        nm.create(112, 950, -130, 0, 209);
                        break;
                    // case 13:
